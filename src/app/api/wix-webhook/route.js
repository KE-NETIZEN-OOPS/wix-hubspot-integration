...
export async function POST(request) {
  try {
    ...
    await enqueue({ syncId: uuidv4(), source: 'wix', eventType: eventType === 'created' ? 'contact.created' : 'contact.updated', contactId, payload: { email, firstName, lastName, phone, updatedAt: updatedAt || Date.now() } })
